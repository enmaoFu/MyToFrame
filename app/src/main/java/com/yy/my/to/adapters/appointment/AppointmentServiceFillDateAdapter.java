 ...
 * @date 2016年10月14日
 */
public class AppointmentServiceFillDateAdapter extends BaseAdapter {
	...
	public AppointmentServiceFillDateAdapter() {
		Date date = new Date();
	...
	public AppointmentServiceFillDateAdapter(Context context, Resources rs, int year_c, int month_c,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.activity_appointment_service_fill_data_itme, null);
		}
