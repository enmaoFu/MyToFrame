...
/**
 * 预约服务医疗机构填写资料页面日期选择适配器
 * @author enmaoFu
 * @date 2016年10月14日
 */
public class AppointmentServiceMechanismFillDateAdapter extends BaseAdapter {
	...
	public AppointmentServiceMechanismFillDateAdapter() {
		Date date = new Date();
	...
	public AppointmentServiceMechanismFillDateAdapter(Context context, Resources rs, int year_c, int month_c,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.activity_appointment_service_mechanism_fill_data_itme, null);
		}
		...
		if (clickTemp == position) {
			...
			tvCalendar.setTextColor(Color.parseColor("#3FD5AF"));
			tvCalendar.setBackgroundResource(R.drawable.shape_appointment_service_fill_date);
		} else {
