 ...
 * @data 2016年11月7日
 */
public class AppointmentServiceMapWholeFragment extends BaseFragment implements View.OnClickListener,PoiSearch.OnPoiSearchListener{
    ...
    protected int bindViews() {
        return R.layout.fragment_appointment_service_map_whole;
    }
